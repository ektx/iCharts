...
$(function() {
	...
	.mousedown(function(e) {
		...
		if ( box.css('transform') == 'none' ) {
			...
			var positionArr = box.css('transform').match(/\-?\d+/g);
			moveObj.left = parseFloat(positionArr[4]);
			moveObj.top = parseFloat(positionArr[5]);
		}
	...
	.mousemove(function(e) {
		if (isHolder) {
			...
			var newY = moveObj.top + moveY;
			var newX = moveObj.left + moveX;
